describe('Unhappy flow - Register as Borrower Individual', () => {
    ...
    it('Register without inputting any data and checklist TnC', () => {
        ...
        cy.checklistTNC();
        cy.klikSubmitButton();
        cy.emailCantNullValidation();
        cy.passwordCantNullValidation();
        cy.passwordConfirmCantNullValidation();
    });
    ...
    it('Register with inputting invalid format password data(No Capital Char)', () => {
        ...
        cy.checklistTNC();
        cy.klikSubmitButton();
        cy.wrongPasswordFormatValidation();
        cy.passwordConfirmCantNullValidation();
    });
    ...
    it('Register with inputting invalid format password data(< 8 Char)', () => {
        ...
        cy.checklistTNC();
        cy.klikSubmitButton();
        cy.wrongPasswordLengthValidation();
        cy.passwordConfirmCantNullValidation();
    });
