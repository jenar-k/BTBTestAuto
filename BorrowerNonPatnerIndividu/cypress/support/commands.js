...
Cypress.Commands.add('validEmail', () => {
    cy.get('[placeholder="Alamat Email"]')
        .type('demoborrower_1@yopmail.com')
        .should('have.value', 'demoborrower_1@yopmail.com');
});
...
//                                                                                   //
///////////////////////////////////////////////////////////////////////////////////////
// ************************************ BORROWER INDIVIDUAL VALIDATION ************************************
Cypress.Commands.add('borrowerIndvValidation', () => {
    // Assertion Logo Batumbu
    cy.get('[alt="Logo Batumbu"]')
        .should('exist')
    //Borrower type validation
    cy.get('[style="display: flex;"]')
        .contains('Peminjam Individu')
});
