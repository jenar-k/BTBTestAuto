...
Cypress.Commands.add('validEmail', () => {
    cy.get('[placeholder="Alamat Email"]')
        .type('testlender2@yopmail.com')
        .should('have.value', 'testlender2@yopmail.com');
});
...
//                                                                                   //
///////////////////////////////////////////////////////////////////////////////////////
// ************************************ LENDER KORPORASI VALIDATION ************************************
Cypress.Commands.add('lenderCorpValidation', () => {
    // Assertion Logo Batumbu
    cy.get('[alt="Logo Batumbu"]')
        .should('exist')
    //Lender type validation
    cy.get('[class="css-20o9ok"]')
        .contains('Pendana Korporasi')
});
...
Cypress.Commands.add('registerKorporasiduButton', () => {
    cy.contains('Korporasi')
        .click();
});
